//add \n before opening tag
var NEED_NL_BEFORE = '|div|p|table|tbody|tr|td|th|title|script|comment|li|meta|h1|h2|h3|h4|h5|h6|hr|ul|ol|option|';
//add \n after opening tag
var NEED_NL_AFTER = '|p|th|br|';
  ...
  for (var i = 0; i < child_length; i++) {
    ...
    case 1: { //ELEMENT_NODE
      ...
      for(var j = 0; j < attr.length; j++) {
        var attr_name = attr[j].nodeName.toLowerCase();
        try {
          var attr_value = child.getAttribute(attr_name, 2);
          text += ' '+attr_name+'="'+fix_attribute(attr_value)+'"';
        } catch (e) {
          valid_attr = false;
        }
